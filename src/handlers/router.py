...
from src.handlers.background import create_clf_handler
from src.handlers.mapped import ModelAlgorithm
from src.app import app

router = APIRouter()


@router.post("/handlers/classification/create", tags=["Classifications-Handlers"])
...
@router.get("/handlers/classification")
async def read_clf_routers():
    ...


@app.delete("/handlers/classification/{router_path}", tags=["Classifications-Handlers"])
